...
- **Aula:** Projeto Redes Sociais
- **Exemplo Prático X:** Este exercício serve de exemplo de um site completo chamado Redes Sociais.
...
1. Clone este repositório em sua máquina local:
   ...
   ```bash
   git clone https://github.com/MarcusFerreira/projeto-redes-sociais.git
